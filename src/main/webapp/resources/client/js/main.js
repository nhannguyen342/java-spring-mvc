(function ($) {
    ...
    navElement.find('a.nav-link').each(function () {
        ...
        const href = link.attr('href'); // Get the href attibute of the link

        if (href === currentUrl) {
            link.addClass('active'); // Add 'active' class if the href matches the current 
        } else {
            link.removeClass('active'); // Remove 'active' class if the href does not matches the current
        }
    });
    ...
    $('.btnAddToCartHomepage').click(function (event) {
        ...
        $.ajax({
            ...
            error: function (response) {
                alert("có lỗi xãy ra, kiểm tra code")
