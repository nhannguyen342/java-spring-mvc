package vn.wins.laptopshop.controller.admin;
...
import vn.wins.laptopshop.service.UploadService;
...
public class ProductController {
    ...
    public String postUpdateProduct(@ModelAttribute("newProduct") @Valid Product pr,
            BindingResult newProductBindingResult, @RequestParam("winsFile") MultipartFile file) {
    ...
    public String getProductDetailPage(Model model, @PathVariable long id) {
        // thêm .get() trả ra đối tượng muốn thao tác
